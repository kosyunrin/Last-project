...
namespace GameName
{
    public static class EntityExtension
    {
        ...
        public static void CreatePlayerManager(this EntityComponent entityComponent, TestData data)
        {
            entityComponent.ShowEntity(typeof(Test), "Test", Constant.AssetPriority.MyAircraftAsset, data);
        }
